...
#SBATCH --output=/home/krisor99/SpMV-Comm-Strats/P2/results/new/1b/fpgaq/%x-%j-stdout.txt
#SBATCH --error=/home/krisor99/SpMV-Comm-Strats/P2/results/new/1b/fpgaq/%x-%j-stderr.txt

module load openmpi-4.1.6
module load cmake-3.22.3
export LC_ALL=C
srun --verbose numactl -C0-47 /home/krisor99/SpMV-Comm-Strats/P2/build/Debug/1b /global/D1/projects/HPC-data/Simula_collection/Lynx_traditional/$matrix
EOF
)
