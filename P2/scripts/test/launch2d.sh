...
job_name="2d_${matrix_name}_${nodes}_nodes_${tasks_per_node}_tasks_${omp_num_threads}_threads"
...
srun --verbose numactl -C0-${total_threads} /home/krisor99/aCG/bin/${partition}/acg-baseline /global/D1/projects/mtx/datasets/suitesparse/$matrix
EOF
)
...
if [ -e "/global/D1/projects/mtx/datasets/suitesparse/$matrix" ]; then
    head -n 1 /global/D1/projects/mtx/datasets/suitesparse/$matrix
