...
job_name="1d_${matrix_name}_${nodes}_nodes_${tasks_per_node}_tasks_${omp_num_threads}_threads"
...
## Use 'ibv_devinfo' output to determine active HCA (mlx5_1:1 or mlx5_1:1)
export IBV_DEVICE="mlx5_1"   # Change to mlx5_1 if needed
export IBV_PORT=1
...
export UCX_NET_DEVICES=mlx5_1:1    # Change to mlx5_1:1 if needed
...
# srun --verbose numactl -C0-${total_threads} /home/krisor99/SpMV-Comm-Strats/P2/build/Debug/1d /global/D1/projects/HPC-data/Simula_collection/Lynx_traditional/$matrix
