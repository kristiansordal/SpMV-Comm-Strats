...
#SBATCH --output=/home/krisor99/SpMV-Comm-Strats/P2/results/lynx/${partition}/%x-%j-stdout.txt
#SBATCH --error=/home/krisor99/SpMV-Comm-Strats/P2/results/lynx/${partition}/%x-%j-stderr.txt
