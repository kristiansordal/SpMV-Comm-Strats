...
job_name="1b_${matrix_name}_${nodes}_nodes_${tasks_per_node}_tasks_${omp_num_threads}_threads"
...
#SBATCH --output=/home/krisor99/SpMV-Comm-Strats/P2/results/lynx/defq/%x-%j-stdout.txt
#SBATCH --error=/home/krisor99/SpMV-Comm-Strats/P2/results/lynx/defq/%x-%j-stderr.txt

module load openmpi-4.1.6
module load cmake-3.22.3
export LC_ALL=C
srun --verbose numactl -C0-63 /home/krisor99/SpMV-Comm-Strats/P2/build/Debug/1b /global/D1/projects/HPC-data/Simula_collection/Lynx_traditional/$matrix
EOF
)
