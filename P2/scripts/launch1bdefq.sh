...
#SBATCH --output=/home/krisor99/SpMV-Comm-Strats/P2/results/new/1b/defq/%x-%j-stdout.txt
#SBATCH --error=/home/krisor99/SpMV-Comm-Strats/P2/results/new/1b/defq/%x-%j-stderr.txt
